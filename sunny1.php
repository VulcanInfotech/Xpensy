                ...
                <div class="tab-content">
					...
					<form class="form-horizontal" name="transport" action="" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="ClaimDate" class="form-control" id="inputEmail" placeholder="Email">
                        </div>
                      </div>
				 ...
				 <form class="form-horizontal" name="meal" action="" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="ClaimDate" class="form-control" placeholder="Email">
                        </div>
                      </div>
                   ...
                   <form class="form-horizontal" name="hotel" action="" method="POST">
				    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">Date</label>
                        <div class="col-sm-10">
                          <input type="text" name="ClaimDate" class="form-control" id="inputEmail" placeholder="Date">
                        </div>
                      </div>
				  ...
				  <div class="tab-pane" id="other">
                   <form class="form-horizontal" name="other" action="" method="POST">
                      ...
                      <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">Date </label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="ClaimDate" id="inputEmail" placeholder="Email">
                        </div>
                      </div>
