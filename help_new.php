...
<div class="container">
        ...
        <div class="col-md-4">
         <center><h4>SIGN UP | LOGIN</h4> </center>           
            <div class="thumbnail" data-toggle="modal" data-target="#myModal_signup">
...
<center><h4>GENERATE  EXPENSE  REPORT</h4> </center>            
            <div class="thumbnail" data-toggle="modal" data-target="#myModal_generate_report">
                <div class="caption"><br><br>
...
<center><h4>SUBMIT  EXPENSE  REPORT</h4> </center>          
            <div class="thumbnail" data-toggle="modal" data-target="#myModal_submit_report">
                <div class="caption"><br><br>
...
<center><h4>GENERATE  PDF  OF  REPORT</h4> </center>          
            <div class="thumbnail" data-toggle="modal" data-target="#myModal_generate_pdf">
                <div class="caption"><br><br>
...
<center><h4>UPDATE  PROFILE</h4> </center>        
            <div class="thumbnail" data-toggle="modal" data-target="#myModal_update_profile">
                <div class="caption"><br><br>
                ...
                <img src="image/update_profile.gif" alt="image" width ="100%" height="100%">
            </div>
      </div>

        <div class="col-md-4">  
<center><h4>UPDATE  PASSWORD</h4> </center>          
            <div class="thumbnail" data-toggle="modal" data-target="#myModal_update_password">
                <div class="caption"><br><br>
                ...
                <img src="image/update_pswrd.gif" alt="image" width ="100%" height="100%">
            </div>
      </div>
...
<!-- Modal signup-->
  <div class="modal fade" id="myModal_signup" role="dialog" style="margin-top:10%;">
        ...
        <div class="modal-body">
							<div class="row">
								...
								<p style="font-size:20; color:red">1.Sign Up/ Login</p>
                                                                <p style="font-size:16; color:black"><li>Create an account to use this xpensy App.</p></li>
                                                                <p style="font-size:16; color:black"><li>Click "Register" on Login menu. </p></li>
                                                                <p style="font-size:16; color:black"><li>Fill up registration details and click on "Create account".</p></li>
                                                                <p style="font-size:16; color:black"><li>Click on registration link sent on your provided Email ID.</p></li>
                                                                <p style="font-size:16; color:black"><li>Once you have register click on Login tab, Enter email address and password to get access to our service.</p></li>
								</ul>
								...
								<div class="col-md-7">
									<a href="#">
										<img src="image/transport1.png" alt="image" width ="100%" height="100%">
					                        ...
					                        <div class="col-md-5">
								<ul>
								<p style="font-size:16; color:black"><li>Select category of expense you would like add i.e.Transport/ Meal/ Hotel/ Other.</p></li>
                            <p style="font-size:16; color:black"><li>To Upload receipts, select "Choose file" & import receipt from your computer.</p></li>
                            <p style="font-size:16; color:black"><li>Entered expenses report is shown in Expense Report section.</p></li> 
								</ul>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p style="font-size:16; color:black"><li>Fill the email details.</p></li>
	   <p style="font-size:16; color:black"><li>Fill the "CC" section if necessary.</p></li>
                            <p style="font-size:16; color:black"><li>Fill the subject line and submit your report.</p></li>
								</ul>
								...
								<div class="col-md-7">
									<a href="#">
										<img src="image/pdf1.png" alt="image" width ="100%" height="100%">
					                        ...
					                        <div class="col-md-5">
								<ul>
								<p style="font-size:16; color:black"><li>Generate a PDF copy of report by simply clicking the "Reports".</p></li>
          <p style="font-size:16; color:black"><li>This report will be saved to your account.</p></li>
	  <p style="font-size:16; color:black"><li>You may also save  a copy of the PDF to your computer.</p></li>
								</ul>
							...
							<div class="row">
								...
								<ul>
								 <p style="font-size:16; color:black"><li>Select "Setting", .</p></li>
                                                                 ...
                                                                 <p style="font-size:16; color:black"><li>Enter the data.</p></li>
       ...
       <div class="modal-body">
							<div class="row">
								...
								<p style="font-size:16; color:black"><li>Select "Setting", .</p></li>
                                                                ...
                                                                <p style="font-size:16; color:black"><li>Next Enter and Re-Enter New Password.</p></li>
                                                                <p style="font-size:16; color:black"><li>Click on Submit Button.</p></li>
								</ul>
