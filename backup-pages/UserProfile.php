...
<img src="dist/img/avatar5.png" class="img-circle" alt="User Image">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="UserProfile.php?&DelAll=all" onclick="confirm('Are you sure you want to delete all records?')"><i class="fa fa-trash o"></i> <span>Delete all</span></a></li>
				...
				<div class="col-xs-12 table-responsive">
                  <table class="table table-custom table-responsive table-hover">
                    <tr>
                      <th>Catagory</th>
                      <th>Description</th>
                      <th><a href="UserProfile.php?&C=ClaimDate&ord=1" title="Sort expenses by date">Date</a></th>
					  <th><a title="Sort expenses by Amount" href="UserProfile.php?&C=ClaimAmt&ord=1">Amount</a></th>
...
<tr class=m>
										<form action="" method="POST" name="Update" role="form" enctype="multipart/form-data">
												...
												<td><div class="form-group">
													<textarea class="form-control" maxlength="100" style="resize:vertical;" rows=1 cols="20" name="ECClass"><?php echo $row1[3]; ?></textarea>
													</div>
												</td>
