...
<head>
    ...
    <title>E-Expense | Customers</title>
        ...
        <div class="row">
            <div class="col-lg-12">
				<h2 style="text-align:center; box-shadow: 5px 5px 5px #888888; height:40px; background-color:#666666; color:white;">For Business</h2>
					  <p style="text-align:center;font-size:22px;">Our Happy Customers</p>
					  <center><h5>See why people choose us as their go-to expense reporting solution!!</h5><center>
				<center>  
				<form name="cust" action="" method="get" style="background-color:#E5E5E5; height:300px; width:600px; margin-top:2%; border-radius:10px; box-shadow: 5px 5px 5px #888888;">
					<p>&nbsp;</p>
					<p>&nbsp;</p><p>&nbsp;</p>
					<h1 align="center" style="font-family:'Times New Roman', Times, serif;color:#000099;  ">Tech Vulcan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vulcan Infotech</h1>
					<p>&nbsp;</p>
					<h3 align="center">Join Our Customers in Global Countries</h3>
...
<!--div id="P_links1"><br>
		<span style="margin-left:45%; color:#FFFFFF; font-style:italic;"><a href="" class="P_anchor">Policy and Terms</a>&nbsp;|&nbsp;<a href="" class="P_anchor">FAQ</a>&nbsp;|&nbsp;<a href="" class="P_anchor">About our Ads</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		Copyright &copy; 2015 Vulcan Infotech</span>
</div-->
